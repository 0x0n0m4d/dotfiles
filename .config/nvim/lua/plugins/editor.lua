...

  {
    ...
    keys = {
      ...
      },
      {
        ...
        desc = "Got to next file on harpoon",
      },
      {
        "<C-p>",
        function()
        ...
        desc = "Got to previous file on harpoon",
      },
    },
  },
  {
